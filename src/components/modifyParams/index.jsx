...
export default function ModifyParams({ data, setData }) {
    ...
    var handleDelete = (key) => {
        ...
        let newApi = { ...data, parameter: { ...data.parameter, params: dataSource.filter((item) => item.key !== key) } }
        setData(newApi)
    };
    ...
    var handleAdd = () => {
        ...
        let newApi = { ...data, parameter: { ...data.parameter, params: [...data.parameter.params, newData] } }
        setData(newApi)
    ...
    var handleSave = (row) => {
        ...
        let newApi = { ...data, parameter: { ...data.parameter, params: newData } }
        setData(newApi)
    };
